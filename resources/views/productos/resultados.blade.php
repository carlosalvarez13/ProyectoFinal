                    ...
                    <div class="p-4">
                        ...
                        <div class="flex items-center"> 
                            <div class="flex items-center mt-2.5 mb-5">
                                @for ($i = 0; $i < 5; $i++)
                                    @if ($i < $producto->media_puntuacion)
                                    ...
                                    @endif
                                @endfor
                                <span class="bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-3">{{ $producto->media_puntuacion }}</span>
                            </div>
                            <div class="ml-auto">
